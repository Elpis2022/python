...
def create_enemy():
    ...
    # enemy.fill(RED)
    enemy = pygame.transform.scale(pygame.image.load('enemy.png').convert_alpha(), (60, 20))
...
def create_bonus():
    ...
    bonus = bonus_img
    bonus = pygame.transform.scale(pygame.image.load('bonus.png').convert_alpha(), (50, 60))
